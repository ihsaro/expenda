...
export function LogonNavigationBar(props) {
  ...
  return (
    <Sider style={logonNavigationBarStyles} collapsible theme="light">
      ...
      <Menu defaultSelectedKeys={[props.selectedKey]} mode="inline">
        <Menu.Item
          key="home"
          icon={<HomeOutlined />}
          onClick={(event) => setSelectedKey(event)}
        >
          Home
        </Menu.Item>
        <Menu.Item
...
export function GuestNavigationBar() {
  ...
  return (
    <Menu mode="horizontal" style={guestNavigationBarStyles}>
      <Menu.Item
        key="guestNavigationBarHome"
        icon={<HomeOutlined />}
        onClick={() => router.push("/")}
      ...
      <Menu.Item
        key="guestNavigationBarRegister"
